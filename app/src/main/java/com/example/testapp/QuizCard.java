...
/*                if (direction == Direction.Right) {
    ...
    private List<ItemModel> addList() {
        ...
        // while(MainActivity.postalcode == null){
        Log.d("mylog", String.valueOf(MainActivity.getPostalcode()));
        // }

        String url = "https://api.yelp.com/v3/businesses/search?location="+postalcode;
